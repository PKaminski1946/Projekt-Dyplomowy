...
class Controller_Node(Node):
    def __init__(self, detection_callback_group, timer_callback_group, global_pos_callback_group):
        ...
        self.roll_controller = Controller(IMG_W_C, 0.30, float('inf'), 1.73, MIN_ROLL, MAX_ROLL) #x, d 0.005
        self.pitch_controller = Controller(IMG_H_C, 0.30, float('inf'), 1.73, MIN_PITCH, MAX_PITCH) #S
        self.throttle_controller = Controller(TARG_SR*IMG_S, 0.55, float('inf'), 4.80, MIN_THROTTLE, MAX_THROTTLE) #0.4, inf, 0 - last working 
