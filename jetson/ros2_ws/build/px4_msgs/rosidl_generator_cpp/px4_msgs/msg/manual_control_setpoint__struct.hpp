...
#ifndef PX4_MSGS__MSG__MANUAL_CONTROL_SETPOINT__STRUCT_HPP_
...
struct ManualControlSetpoint_
{
  ...
  explicit ManualControlSetpoint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ManualControlSetpoint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // PX4_MSGS__MSG__MANUAL_CONTROL_SETPOINT__STRUCT_HPP_
