...
#ifndef PX4_MSGS__MSG__VEHICLE_LOCAL_POSITION__STRUCT_HPP_
#define PX4_MSGS__MSG__VEHICLE_LOCAL_POSITION__STRUCT_HPP_
...
struct VehicleLocalPosition_
{
  ...
  explicit VehicleLocalPosition_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit VehicleLocalPosition_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : delta_xy(_alloc),
    delta_vxy(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // PX4_MSGS__MSG__VEHICLE_LOCAL_POSITION__STRUCT_HPP_
